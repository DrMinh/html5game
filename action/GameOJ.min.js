...
src:"./asset/tankBigSize.png",id:"tankBigSize"},{src:"./asset/tankTurret.png",id:"tankTurret"},{
src:"./asset/enemy.png",id:"enemy"},{src:"./asset/enemy_turret.png",id:"enemyTurret"},{
src:"./asset/effect.png",id:"effect"},{src:"./asset/map_1.png",id:"map_1"},{src:"./asset/hpbar.png",
id:"hpbar"},{src:"./asset/menuimage_r.png",id:"menuImage"},{src:"./asset/UIList.png",id:"uiList"},{
...
src:"./sound/effect4.ogg",id:"effect4"},{src:"./sound/win1.ogg",id:"win1"},{
src:"./sound/tickingL.ogg",id:"ticking"},{src:"./sound/bell.ogg",id:"bell"},{src:"./sound/s1.ogg",
id:"s1"},{src:"./sound/kill.ogg",id:"kill"},{src:"./sound/peffect1.ogg",id:"peffect1"},{
...
volume:.2}),this.SoundMark.s1=-1,this.Sound.kill=new Howl({src:["sound/kill.ogg"],autoplay:!1,
loop:!1,volume:.2}),this.SoundMark.kill=-1,this.Sound.ticking=new Howl({src:["sound/tickingL.ogg"],
autoplay:!1,loop:!1,volume:.2}),this.SoundMark.ticking=-1,this.Sound.theme1=new Howl({
src:["sound/theme1.ogg"],autoplay:!1,loop:!0,volume:.2}),this.SoundMark.theme1=-1},
playSound:function(e,t,a,i=0){if(i){if(gameOJ.SoundMark[e]===i)return;gameOJ.SoundMark[e]=i}
let n=1,s=Math.max(a,t);n=1-.1*~~(s/50),n<=0||(gameOJ.Sound[e].volume(n),gameOJ.Sound[e].play())},
openFullscreen:function(){if(!document.fullscreenElement){gameOJ.gameSetting.fullScreen=1
;var e=gameOJ.stage.canvas
...
;this.SpriteSheetList.TankBigSize=new createjs.SpriteSheet(r);var l={
...
;this.SpriteSheetList.bullet=new createjs.SpriteSheet(l);var o={
...
;this.SpriteSheetList.icon=new createjs.SpriteSheet(c);var h={
images:[gameOJ.loadMC.getAsset("logo")],frames:{width:200,height:64},animations:{
victory:[1,3,!0,.1],defeat:[4]}};this.SpriteSheetList.logo=new createjs.SpriteSheet(h);var d={
images:[gameOJ.loadMC.getAsset("skill")],frames:{width:40,height:40},animations:{back:[0],
skill1_1:[1],skill2_1:[2],skill3_1:[3]}};this.SpriteSheetList.skill=new createjs.SpriteSheet(d)
;var u={images:[gameOJ.loadMC.getAsset("boxy_font")],frames:{width:9,height:8},animations:{c0:0,
c1:1,c2:2,c3:3,c4:4,c5:5,c6:6,c7:7,c8:8,c9:9,"c:":82,c_:79,"c+":65,"c.":68,"c?":35,"c!":69,"c-":67,
A:10,B:11,C:12,D:13,E:14,F:15,G:16,H:17,I:18,J:19,K:20,L:21,M:22,N:23,O:24,P:25,Q:26,R:27,S:28,T:29,
U:30,V:31,W:32,X:33,Y:34,Z:35,a:39,b:40,c:41,d:42,e:43,f:44,g:45,h:46,i:47,j:48,k:49,l:50,m:51,n:52,
o:53,p:54,q:55,r:56,s:57,t:58,u:59,v:60,w:61,x:62,y:63,z:64}}
;this.SpriteSheetList.font=new createjs.SpriteSheet(u);var p={
...
;this.SpriteSheetList.map_1=new createjs.SpriteSheet(p),this.AniL1NameList.push(123,16,17,56,57)
;var O={images:[gameOJ.loadMC.getAsset("hpbar")],frames:{width:60,height:20}}
;this.SpriteSheetList.hpbar=new createjs.SpriteSheet(O)},resetGame:function(){gameOJ.bulletList=[],
...
t>15e3&&gameOJ.gameTime<15e3&&(gameOJ.playSound("bell",0,0),gameOJ.playSound("ticking",100,100))
...
t.displayScore=1e3,gameOJ.playSound("kill",300,300),t.gotoAndPlay("kill"+e)},
...
;var s=new createjs.Bitmap(gameOJ.loadMC.getAsset("uiList"))
;s.sourceRect=new createjs.Rectangle(30,295,110,110),s.regX=s.regY=55,s.x=gameOJ.gameW/2,
s.y=gameOJ.gameH/2+80+50
;var r=new createjs.Container,l=new createjs.Text(document.getElementById("userJoinGameName").value,"15px Arial","#FFFFFF"),o=new createjs.Shape((new createjs.Graphics).beginStroke("white").f("#999999").drawRect(0,0,200,30))
;l.maxWidth=200,l.maxHeight=30,l.textAlign="center",l.x=100,l.y=7,r.addChild(o,l),
...
;var c=new createjs.Container,h=new createjs.Sprite(this.SpriteSheetList.icon)
;h.gotoAndStop(gameOJ.gameSetting.fullScreen?"fullScreenExit":"fullScreenGo"),h.x=gameOJ.gameW-50,
h.y=-10;var d=new createjs.Sprite(this.SpriteSheetList.icon)
;return d.gotoAndStop(gameOJ.gameSetting.allowSound?"soundAllow":"soundNotAllow"),
d.x=gameOJ.gameW-100,d.y=-10,c.addChild(h,d),gameOJ.stage1.addChild(e,g,t,a,i,s,m,r,c),
...
i.getChildAt(gameOJ.pickedTank-1).visible=!0):(i.getChildAt(gameOJ.pickedTank-1).visible=!1,
gameOJ.pickedTank++,i.getChildAt(gameOJ.pickedTank-1).visible=!0)}),s.on("mousedown",()=>{
...
}),h.on("mousedown",()=>{"fullScreenGo"===h.currentAnimation?(h.gotoAndStop("fullScreenExit"),
gameOJ.openFullscreen()):(h.gotoAndStop("fullScreenGo"),gameOJ.exitFullscreen())}),
void d.on("mousedown",()=>{"soundAllow"===d.currentAnimation?(d.gotoAndStop("soundNotAllow"),
gameOJ.changeSoundGame(0)):(d.gotoAndStop("soundAllow"),gameOJ.changeSoundGame(1))})}},
...
gameOJ.playerControl.touchShoot=!1)),gameOJ.player){
let e=gameOJ.player.tankAimStore[gameOJ.playerControl.aimSpriteIndex]
;gameOJ.player.tankAimSprite.getChildAt(0)!==e&&(gameOJ.player.tankAimSprite.removeAllChildren(),
gameOJ.player.tankAimSprite.addChild(e)),
gameOJ.player.tankAimSprite.visible=gameOJ.playerControl.touchAim}
...
n.removeAllChildren()
;let r=-40,l=i.slot.length>=5,o=gameOJ.stage2.getChildAt(gameOJ.staticValues.alertLayerNumer).getChildAt(5).getChildAt(3)
;for(let e=3;e<gameOJ.slotInfor.length;e++){let t=gameOJ.slotInfor[e]
;if(!i.canBuildSlot(t.id)||l&&0===t.giveSlot)o.getChildAt(t.id-4).buildCon.getChildAt(4).gotoAndPlay("installOff");else{
...
baseRotaion:null,tankPosition:null,turretRotation:null},this.tankAimSprite=new createjs.Container,
...
;let h=new createjs.Sprite(gameOJ.SpriteSheetList.effect_p,"effect2");h.visible=!1,h.regX=h.regY=25,
h.alpha=.5,h.effectType=2;let d=new createjs.Container;d.visible=!1,d.effectType=3
...
this.tankSlotBar.scaleX=this.tankSlotBar.scaleY=.7,this.changePosition(e,t,s,15),
...
var t=45*e,a=5,i=this.tankBaseSprite.rotation;if(i<180)var n=i+180,s=i,r=1;else n=i,s=i-180,r=-1
...
e.touchShoot=!0,e.turretAim=!1,e.touchAim=!1}),s.on("mousedown",t=>{e.touchSkillEvent(t,e,1)}),
